...
export const validTrasladoCartaPorte31: Cfdi40CartaPorteDocument = {
  ...
  cartaPorte:{
    ...
    locations:[
      ...
      { type:'Destino', id:'DE000001', rfc:'BBB010101BBB', dateTime:'2026-08-21T21:30:00', distanceKm:22, address:{ postalCode:'03100', state:'CMX', country:'MEX', municipality:'014', street:'Destino Demo' } }
    ],
    ...
    figures:[{ figureType:'01', rfc:'CCC010101CCC', name:'OPERADOR DEMO', licenseNumber:'LIC-DEMO-001' }]
  }
};
